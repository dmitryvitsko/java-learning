    ...
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            if (command == 1) {
                ...
                String animal = scanner.next();
                boolean isAnimal = animals.contains(animal); // допишите условия
                if (isAnimal) System.out.println(animal + " на месте! Приходите посмотреть.");
                else System.out.println("Такого животного сейчас нет в нашем зоопарке.");
            } else {
                break;
            }
        }
